...
|:---|:---|:---|
| **HU01** | **Login:** Como usuario registrado quiero iniciar sesión con mi correo y contraseña para acceder al panel de control. | Validación de campos, manejo de tokens y redirección exitosa. |
| **HU02** | **Registro:** Como nuevo usuario quiero crear una cuenta con mis datos básicos para poder utilizar el sistema. | Almacenamiento seguro de datos y cifrado de contraseñas. |
